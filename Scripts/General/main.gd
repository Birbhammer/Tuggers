...
@onready var chad: CharacterBody2D = $VBoxContainer/SubViewportContainer/SubViewport/TestWorld/LeftSide/Chad
@onready var nerd: CharacterBody2D = $VBoxContainer/SubViewportContainer/SubViewport/TestWorld/LeftSide/Nerd
